...
nocheck Add menu command:   "Objects",  "Open", "Read HTS Label file...", "", 0, "hts_scripts/read_hts_lab.praat"

nocheck Add action command: "TextGrid", 0, "", 0, "", 0, "Save as HTS Label file...", "", 0, "hts_scripts/write_hts_lab.praat"
